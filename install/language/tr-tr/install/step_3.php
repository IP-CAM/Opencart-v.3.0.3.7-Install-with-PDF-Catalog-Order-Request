...
$_['error_db_prefix']        = 'DB Öneki yalnızca a-z aralığında küçük harfler, 0-9 ve alt çizgi içerebilir.';
$_['error_db_connect']       = 'Hata: Veritabanına bağlanılamadı! Lütfen veritabanı sunucusunun, kullanıcı adının ve şifrenin doğru olduğundan emin olun.';
$_['error_username']         = 'Kullanıcı gerekli!';
$_['error_password']         = 'Parola gerekli!';
$_['error_email']            = 'E-Posta Adresi geçerli değil!';
$_['error_config']           = 'Hata: config.php dosyasına yazılamadı! Lütfen doğru izinleri ayarlayıp ayarlamadığınızı kontrol edin: ';